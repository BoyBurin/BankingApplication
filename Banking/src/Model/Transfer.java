...
public class Transfer {
    ...
    public void transfer(CustomerAccount my, CustomerAccount target, int amount){
    ...
    private void updateCustomer(CustomerAccount customer, int amount){
    ...
    private void addTransaction(CustomerAccount customer, int amount){
        int id = Integer.parseInt(customer.getID().substring(1));
        double balance = customer.getBalance() + amount;
